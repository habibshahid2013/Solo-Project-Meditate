                                ...
                                .map((host, index) => {
                                    ...
                                    return (
                                        ...
                                        >
                                            ...
                                            <TableCell align="right">{host.preferred_method}</TableCell>
                                            ...
                                            <Button onClick={editHostASession(host.id)} align="right" color="secondary" variant="contained" size="large">EDIT</Button>
                                        </TableRow>
                                    );
                                })}
                            {emptyRows > 0 && (
